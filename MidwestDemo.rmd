...
p + geom_point((aes(color = state))) + ggtitle("College Education Vs Total Proverty") + xlab("Percent College Educated") + ylab("Percentage of Total proverty")
```
...
####Link for published Shiny Application:  
  [Up](#A)
